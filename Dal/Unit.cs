...
namespace guanbingking.DAL
{
	...
	public partial class Unit
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "Unit"); 
		}
		...
		public bool Add(guanbingking.Model.Unit model)
		{
			...
			strSql.Append("Id,UnitName,Quantity,Price,Cost,ProductId,IsDefault)");
			strSql.Append(" values (");
			strSql.Append("@Id,@UnitName,@Quantity,@Price,@Cost,@ProductId,@IsDefault)");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4),
					new SqlParameter("@UnitName", SqlDbType.VarChar,1),
		...
		public guanbingking.Model.Unit GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,UnitName,Quantity,Price,Cost,ProductId,IsDefault from Unit ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;

			guanbingking.Model.Unit model=new guanbingking.Model.Unit();
		...
		/// 得到一个对象实体
		/// </summary>
		public guanbingking.Model.Unit DataRowToModel(DataRow row)
		{
			guanbingking.Model.Unit model=new guanbingking.Model.Unit();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,UnitName,Quantity,Price,Cost,ProductId,IsDefault ");
